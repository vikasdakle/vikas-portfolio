        ...
        <section className="text-gray-400  body-font">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img className="object-cover object-center rounded" alt="hero" src="https://media.istockphoto.com/id/522278625/photo/confident-superhero.jpg?s=612x612&w=0&k=20&c=uO2IPOwu6WL65CHCaSiYIlesPJBIRDh4-Bqrk4cLJ-U=" />
                </div>
            </div>
        </section>
    </>
